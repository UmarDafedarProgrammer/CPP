...
int main()
{
    ...
    // cstring="Hello"; 
    // when string is assigned, it adds a null character automatically
    // error: incompatible types in assignment of ‘const char [6]’ to ‘char [5]’
    // main.cpp:17:13: error: invalid array assignment
    // cstring="Hello"; // when string is assigned, it adds a null character automatically
